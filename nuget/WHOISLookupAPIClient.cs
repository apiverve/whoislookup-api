...
namespace APIVerve.API.WHOISLookup
{
    ...
    /// <summary>
    /// Client for the WHOISLookup API
    /// </summary>
    public class WHOISLookupAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/whoislookup";
        ...
        public WHOISLookupAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public WHOISLookupAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public WHOISLookupAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, WHOISLookupQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(WHOISLookupQueryOptions options)
        {
        ...
        public ResponseObj Execute(WHOISLookupQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(WHOISLookupQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(WHOISLookupQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(WHOISLookupQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(WHOISLookupQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(WHOISLookupQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(WHOISLookupQueryOptions options)
        {

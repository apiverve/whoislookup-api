// Package whoislookup provides a Go client for the WHOIS Lookup API.
//
// For more information, visit: https://whoislookup.apiverve.com?utm_source=go&utm_medium=readme
package whoislookup
...
const (
	baseURL        = "https://api.apiverve.com/v1/whoislookup"
	defaultTimeout = 30 * time.Second
)

// Client is the WHOIS Lookup API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new WHOIS Lookup API client.
...
// Execute makes a request to the WHOIS Lookup API with typed parameters.
//
...
//   - domain (required): string - The domain name for which you want to get the registration data (e.g., myspace.com)

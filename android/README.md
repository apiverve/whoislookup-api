...
```gradle
dependencies {
    implementation 'com.github.apiverve:whoislookup-api:1.1.14'
}
```
...
```java
import com.apiverve.whoislookup.WHOISLookupAPIClient;
import com.apiverve.whoislookup.APIResponse;
import com.apiverve.whoislookup.APIException;

// Initialize the client
WHOISLookupAPIClient client = new WHOISLookupAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/whoislookup](https://docs.apiverve.com/ref/whoislookup)
...
- **Documentation:** [https://docs.apiverve.com/ref/whoislookup](https://docs.apiverve.com/ref/whoislookup)
- **Issues:** [GitHub Issues](https://github.com/apiverve/whoislookup-api/issues)
